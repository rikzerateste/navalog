      ...
      >
        ...
        <div className={styles.form}>
          <div className={styles.title}>
            ...
            {cts ? <a>Editar Cartao de Tripulação de Segurança</a> : <a>Novo Cartao de Tripulação de Segurança</a>}
          </div>
            ...
            <div className={styles.embarcacaoCategoria}>
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  className={`${styles.inputText} ${ctsErrors.Embarcacao ? styles.error : ''}`}
                  options={embarcacoes}
              ...
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${ctsErrors.Data_emissao ? styles.error : ''}`}
            ...
            <div className={styles.nivelQuantidade}>
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  optionLabel="name"
                  className={`${styles.inputText} ${ctsErrors.Tipo_de_Tripulante ? styles.error : ''}`}
