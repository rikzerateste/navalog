      ...
      <div className={styles.container}>
        <div className={styles.top}>
          ...
          <div className={styles.menus}>
            <Link href="/portal" className={`${styles.button} ${activeTab === 'portal' ? styles.active : ''}`} onClick={(e) => handleItemClick('portal')}>
            ...
            <div className={styles.cadastros}>
              ...
              <Link href="/portal/empresas/page" className={`${styles.button} ${activeTab === 'empresas' ? styles.active : ''}`} onClick={(e) => handleItemClick('empresas')}>
                <EmpresasIcon active={activeTab === 'empresas'}/>
                <span>Empresas</span>
              </Link>  
              <Link href="/portal/embarcacoes/page" className={`${styles.button} ${activeTab === 'embarcacoes' ? styles.active : ''}`} onClick={(e) => handleItemClick('embarcacoes')}>
                <Image src={EmbarcacoesIcon} alt={""}></Image>
                <span>Embarcações</span>
              </Link> 
              <Link href="/portal/tripulantes/page" className={`${styles.button} ${activeTab === 'tripulantes' ? styles.active : ''}`} onClick={(e) => handleItemClick('tripulantes')}>
            ...
            <div className={styles.despachos}>
              ...
              <Link href="/portal/listaPassageiros/page" className={`${styles.button} ${activeTab === 'listaPassageiros' ? styles.active : ''}`} onClick={(e) => handleItemClick('listaPassageiros')}>
                <Image src={ListaPassageirosIcon} alt={""}></Image>
                <span>Lista de passageiros</span>
              </Link>  
              <Link href="/portal/pedidoDespacho/page" className={`${styles.button} ${activeTab === 'pedidoDespacho' ? styles.active : ''}`} onClick={(e) => handleItemClick('pedidoDespacho')}>
                <Image src={PedidosDespachoIcon} alt={""}></Image>
                <span>Pedido de despacho</span>
              </Link> 
              <Link href="/portal/cartaoTripulantes/page" className={`${styles.button} ${activeTab === 'cartaoTripulantes' ? styles.active : ''}`} onClick={(e) => handleItemClick('cartaoTripulantes')}>
