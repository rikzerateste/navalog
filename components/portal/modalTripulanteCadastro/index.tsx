...
const ModalTripulanteCadastro: React.FC<ModalTripulanteCadastroProps> = ({ onClose, onSuccess, tripulante }) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setNovaTripulante((prevTripulante) => ({
      ...prevTripulante,
      [name]: name === "Nacionalidade" || name === "Controle" ? Number(value) : value,
    }));
  };
  ...
  const [tripulanteErros, setTripulanteErros] = useState<{ [key: string]: boolean }>({});
  ...
  const handleSubmit = async () => {
    if (!validateTripulanteFields()) {
      ...
      const url = tripulante ? "/api/portal/tripulantes/updateCrew" : "/api/portal/tripulantes/createCrew";
          ...
          <div className={styles.informacoes}>
            ...
            <div className={styles.nomeFuncao}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${tripulanteErros.Nome ? styles.error : ''}`}
              ...
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  options={funcao}
                  className={`${styles.inputText} ${tripulanteErros.Funcao ? styles.error : ''}`}
                  onChange={(e: any) => setNovaTripulante((prevTripulante) => ({
                    ...prevTripulante,
                    Funcao: e.value,
                  }))}
                />
            ...
            <div className={styles.docVenci}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${tripulanteErros.Documento ? styles.error : ''}`}
                  onChange={handleChange}
              ...
              <div className={styles.opcao}>
                ...
                <InputMask value={novaTripulante.Vencimento_CIR}
                  onChange={handleDateVencimentoChange}
                  mask="99/99/9999"
                  className={`${styles.inputText} ${tripulanteErros.Vencimento_CIR ? styles.error : ""
                    }`}
                  slotChar="dd/mm/yyyy" />
              </div>
            </div>
            ...
            <div className={styles.dtNascNacio}>
              <div className={styles.opcao}>
                ...
                <InputMask value={novaTripulante.Data_de_nascimento}
                  onChange={handleDateChange}
                  mask="99/99/9999"
                  className={`${styles.inputText} ${tripulanteErros.Data_de_nascimento ? styles.error : ""
                    }`}
                  slotChar="dd/mm/yyyy" />
              </div>
              <div className={styles.opcao}>
                ...
                <InputMask
                  ...
                  mask="99.999.999-99"
                  className={`${styles.inputText} ${tripulanteErros.RG ? styles.error : ""}`}
                />
              ...
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  className={`${styles.inputText} ${tripulanteErros.Nacionalidade ? styles.error : ''}`}
                  onChange={(e: any) => setNovaTripulante((prevTripulante) => ({
                    ...prevTripulante,
