							...
							<div className={styles.opcao}>
								...
								<Dropdown
									...
									className={`${styles.inputText} ${
										despachoErrors.Despacho_embarcacao ? styles.error : ""
									}`}
									onChange={(e) =>
										handleDropdownChange(e, "Despacho_embarcacao")
									}
								/>
							</div>
							<div className={styles.opcao}>
						...
						<div className={styles.comandanteEDespachoInfo}>
							<div className={styles.opcao}>
								...
								<Dropdown
									...
									options={tripulantes}
									className={`${styles.inputText} ${
										despachoErrors.Despacho_comandante ? styles.error : ""
									}`}
									onChange={(e) =>
						...
						<div className={styles.dataPortoDeEstadia}>
							<div className={styles.opcao}>
								...
								<InputMask
									...
									mask="99/99/9999"
									className={`${styles.inputText} ${
										despachoErrors.Data_do_despacho ? styles.error : ""
									}`}
									slotChar="dd/mm/yyyy"
								/>
                ...
                /> */}
							...
							<div className={styles.opcao}>
								...
								<InputText
									...
									className={`${styles.inputText} ${
										despachoErrors.Porto_de_Estadia ? styles.error : ""
									}`}
									onChange={handleChange}
								/>
							</div>
						...
						<div className={styles.opcao}>
							...
							<InputText
								...
								className={`${styles.inputText} ${
									despachoErrors.Despacho_obs ? styles.error : ""
								}`}
								onChange={handleChange}
							/>
						</div>
						...
						<div className={styles.radioFreqTransponder}>
							<div className={styles.opcao}>
								...
								<InputText
									...
									className={`${styles.inputText} ${
										despachoErrors.Frequencia ? styles.error : ""
									}`}
									onChange={handleChange}
								/>
							</div>
							...
							<div className={styles.infoCertificado}>
								...
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											despachoErrors.Informacao_sobre_vencimento_do_certificado_ou_documento
												? styles.error
												: ""
										}`}
										onChange={handleChange}
