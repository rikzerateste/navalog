...
const ModalEmbascacoesCadastro: React.FC<ModalEmbascacoesCadastroProps> = ({
  ...
  const criarEmbarcacao = async () => {
    try {
      ...
      alert(
        `Erro ao adicionar a nova embarcação: ${error.response?.data?.error || error.message
        }`
      );
    }
  };
          ...
          <div className={styles.informacoes}>
            ...
            <div className={styles.embarcacaoEmpresa}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Embarcacao ? styles.error : ""
                    }`}
              ...
              <div>
                <div className={styles.opcao}>
                  ...
                  <InputText
                    ...
                    className={`${styles.inputText} ${errors.Inscricao ? styles.error : ""
                      }`}
                    onChange={handleChange}
            ...
            <div className={styles.opcao}>
              ...
              <Dropdown
                ...
                options={empresas}
                className={`${styles.inputText} ${errors.Empresa ? styles.error : ""
                  }`}
                onChange={(e) =>
                  setNovaEmbarcacao((prevEmbarcacao) => ({
                    ...prevEmbarcacao,
            ...
            <div className={styles.navPropulsaoAtvd}>
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  options={navegacao}
                  className={`${styles.inputText} ${errors.Navegacao ? styles.error : ""
                    }`}
                  onChange={(e) =>
                    setNovaEmbarcacao((prevEmbarcacao) => ({
                      ...prevEmbarcacao,
              ...
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  options={propulsao}
                  className={`${styles.inputText} ${errors.Id_propulsao ? styles.error : ""
                    }`}
                  onChange={(e) =>
                    setNovaEmbarcacao((prevEmbarcacao) => ({
                      ...prevEmbarcacao,
              ...
              <div className={styles.opcao}>
                ...
                <Dropdown
                  ...
                  options={atividade}
                  className={`${styles.inputText} ${errors.Atividade ? styles.error : ""
                    }`}
                  onChange={(e) =>
                    setNovaEmbarcacao((prevEmbarcacao) => ({
                      ...prevEmbarcacao,
            ...
            <div className={styles.arqToneComprimento}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Arqueacao_Bruta ? styles.error : ""
                    }`}
                  onChange={handleChange}
                />
              </div>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Tonelagem_porte_bruto ? styles.error : ""  }`}
              ...
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Comprimento_Total ? styles.error : ""
                    }`}
                  onChange={handleChangeNumber}
                />
              </div>
            ...
            <div className={styles.tonelagemLiquidaObservacao}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Tonelagem_porte_liquido ? styles.error : ""
                    }`}
                  onChange={handleChangeNumber}
                />
              </div>
              ...
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Observacao ? styles.error : ""
                    }`}
                  onChange={handleChange}
                />
              </div>
            ...
            <div className={styles.tribunalMaritimoTonelagemLiquindo}>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Registro_Tribunal_Maritimo ? styles.error : ""} `}
                  onChange={handleChange}
                />
              </div>
              <div className={styles.opcao}>
                ...
                <InputText
                  ...
                  className={`${styles.inputText} ${errors.Seguro ? styles.error : ""} `}
                  onChange={handleChange}
                />
              </div>
            </div>
