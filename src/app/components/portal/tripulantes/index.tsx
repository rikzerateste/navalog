...
import ModalTripulanteCadastro from "@/src/app/components/portal/modalTripulanteCadastro/index";
...
const Page = () => {
  ...
  const [tripulanteToDelete, setTripulanteToDelete] = useState<string | null>(null);
