...
import ModalEmpresaCadastro from "@/src/app/components/portal/modalEmpresaCadastro/index";
...
const Page = () => {
    ...
    if (token) {
      if (isTokenExpired(token)) {
        ...
        try {
          ...
          const empresasLimpas = response.data.map((empresa:any) => ({
            ...empresa,
  ...
  return (
    <>
      ...
      {modal && (
        <ModalEmpresaCadastro onClose={onClose} onSuccess={onSuccess} empresa={selectedEmpresa} />
      )}
