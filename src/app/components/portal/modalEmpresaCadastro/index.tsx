...
const ModalEmpresaCadastro: React.FC<ModalEmpresaCadastroProps> = ({
	onClose,
	onSuccess,
	empresa,
}) => {
	...
	const criarEmpresa = async () => {
		try {
			...
			const res = await axios.post(
				"/api/portal/empresa/createCompanyTeste",
				novaEmpresa
			);
			setNovaEmpresa({
				Empresa: "",
			...
			alert(
				`Erro ao adicionar a nova empresa: ${
	...
	useEffect(() => {
		if (empresa) {
			...
			setSelectedEstados(
				estados.find((estado) => estado.sigla === empresa.UF) || null
			);
	...
	const handleSubmit = async () => {
		if (!validateEmpresaFields()) {
			...
			const url = empresa
				? "/api/portal/empresa/updateCompany"
				: "/api/portal/empresa/createCompanyTeste";
						...
						<div className={styles.opcao}>
							...
							<InputText
								...
								className={`${styles.inputText} ${
									empresaErrors.Empresa ? styles.error : ""
								}`}
						...
						<div className={styles.cnpjInscEstadual}>
							<div className={styles.opcao}>
								...
								<InputMask
									...
									className={`${styles.inputText} ${
										empresaErrors.CNPJ ? styles.error : ""
									}`}
								/>
							</div>
							<div className={styles.opcao}>
								...
								<InputText
									...
									className={`${styles.inputText} ${
										empresaErrors.Inscricao_Estadual ? styles.error : ""
									}`}
									onChange={handleChange}
								/>
							</div>
						...
						<div className={styles.certificadoVencimento}>
							<div className={styles.opcao}>
								...
								<InputText
									...
									className={`${styles.inputText} ${
										empresaErrors.Empresa_certificado ? styles.error : ""
									}`}
									onChange={handleChange}
								/>
							</div>
							<div className={styles.opcao}>
								...
								<InputMask
									value={novaEmpresa.Empresa_vencecert}
									onChange={handleVencimentoChange}
									mask="99/99/9999"
									className={`${styles.inputText} ${
										empresaErrors.Empresa_vencecert ? styles.error : ""
									}`}
								/>
							</div>
						</div>
							...
							<div className={styles.enderecoNumero}>
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											empresaErrors.Endereco ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											empresaErrors.Num ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
							...
							<div className={styles.bairroCep}>
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											empresaErrors.Bairro ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
							...
							<div className={styles.cidadeEstado}>
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											empresaErrors.Cidade ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
						...
						<div className={styles.informacoes}>
							...
							<div className={styles.contatoEmail}>
								<div className={styles.opcao}>
									...
									<InputText
										...
										required
										className={`${styles.inputText} ${
											empresaErrors.Email ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
								<div className={styles.opcao}>
									...
									<InputText
										...
										className={`${styles.inputText} ${
											empresaErrors.Contato ? styles.error : ""
										}`}
										onChange={handleChange}
									/>
								</div>
							...
							<div className={styles.numerosInputs}>
								<div className={styles.opcao}>
									<label>Fone 1:</label>
									<InputMask
										value={novaEmpresa.Fone_1}
										onChange={handleFone1Change}
										mask="(99) 99999-9999"
										className={`${styles.inputText} ${
											empresaErrors.Fone_1 ? styles.error : ""
										}`}
									/>
								</div>
								<div className={styles.opcao}>
									<label>Fone 2:</label>
									<InputMask
										value={novaEmpresa.Fone_2}
										onChange={handleFone2Change}
										mask="(99) 99999-9999"
										className={`${styles.inputText} ${
											empresaErrors.Fone_2 ? styles.error : ""
										}`}
									/>
								</div>
								<div className={styles.opcao}>
